...
<head>
    ...
    <title>AcademyWorld |Login </title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">Welcome to AcademyWorld</h2>
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    <form class="m-t"  method="POST" action="{{ route('admin_login') }}">
                        @csrf
                    ...
                    <p class="m-t">
                        <small>Contact with provider for any query.. </small>
                    </p>
                </div>
            </div>
        </div>
