...
<head>
    ...
    <title>AcademyWorld | Video list</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All Videos are listed here..</h5>
                    ...
                    @foreach($videos as $video)
                        <tr class="gradeX">
                            <td>{{$counter}}</td>
                            <td class="center">{{$video->name}}</td>
                            <td class="center">{{$video->description}}</td>
                            <td class="center">{{$video->course->name}}</td>
                            <td class="center">{{$video->created_at}}</td>
