        ...
        <div class="row m-0" style="display: flex;justify-content:center;width:100%;">
            <div class="col-md-8" style="padding-top: 30px;width:100%;">
                ...
                <form class="form-light mt-20" method="POST" role="form" action="{{ route('student_setting.update') }}"
					...
					<div class="form-group">
                        <label>Skills</label>
                        <input type="text" class="form-control"  name="skills" value="{{Auth::user()->skills}}" required>
                    </div>

					<div class="form-group">
                        <label>Major Suject</label>
						...
						<script>
							let propertySelect = document.getElementById('subject');
							propertySelect.value = `{{Auth::user()->subject}}`;
						</script>
                    </div>
					<div class="form-group">
                        <label>Qualification</label>
                        <input type="text" class="form-control"  name="qualification" value="{{Auth::user()->qualification}}" required>
                    </div>
					
                    <div class="form-group">
                        <label>Description/Bio</label>
                        <textarea class="form-control" id="message" placeholder="Write you message here..."
                            style="height:100px;" name="description" >{{Auth::user()->description}}</textarea>
                    </div>
